...
BASE_URL = (
    ...
    'releases/download/green'
)
DEFAULT_YEAR = 2019
DEFAULT_WORK_DIR = '/tmp/mage_nyc_taxi/green'
...
@data_loader
def load_green_taxi_2019(*args, **kwargs):
    """Stage twelve compressed monthly Green Taxi files on the worker."""
    ...
    for month in range(1, 13):
        filename = f'green_tripdata_{year}-{month:02d}.csv.gz'
